...
public class PopUpLinearLayout extends LinearLayout {
    ...
    int[] colorValArr = new int[]{0xffd3deff, 0xffd3fff7, 0xffd3ffd5, 0xffffecd3, 0xffead3ff, 0xfffffddb};
    ...
    public void setBgPaintColor(int bgColor) {
    ...
    private void init(Context context) {
        ...
        bgPaint.setStrokeCap(Paint.Cap.ROUND);
        bgPaint.setStyle(Paint.Style.FILL);
        bgPaint.setColor(colorValArr[bgColor]);
        bgPaint.setAntiAlias(true);
